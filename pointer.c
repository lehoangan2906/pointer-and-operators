...
int main()
{
   ...
   Gioongs như hàm scanf() có thể thay đổi giá trị của biến khi nhận vào địa chỉ,
   con trỏ khi có địa chỉ của một biến hoàn toàn có thể thay đổi giá trị của biến đó theo cách dưới đây:
   */
    ...
    *p = 100;
    ...
    chỉ là một cách khác để lấy được giá trị của biến đó.
    */
